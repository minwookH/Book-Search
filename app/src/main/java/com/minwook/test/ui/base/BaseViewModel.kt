...
abstract class BaseViewModel<Event : UiEvent, State : UiState, Effect : UiEffect> : ViewModel() {
    ...
    private val initState : State by lazy { onInitState() }
    ...
    private val _dataLoadingState : MutableStateFlow<Boolean> = MutableStateFlow(false)
    ...
    fun <T> Flow<T>.loading(): Flow<T> {
        return onStart { _dataLoadingState.value = true }
            .onCompletion { _dataLoadingState.value = false }
    }
}